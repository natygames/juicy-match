...
public class Match5Tutorial implements Tutorial {
    ...
    // Constructors
    //--------------------------------------------------------
    public Match5Tutorial(Engine engine) {
    ...
    public void show(GameActivity activity) {
        ...
        mFingerEffect.activate(marginX + 1200, marginX + 1200, marginY + 1300, marginY + 1600);
    }
    //========================================================
