...
public class CombineTutorial implements Tutorial {
    ...
    // Constructors
    //--------------------------------------------------------
    public CombineTutorial(Engine engine) {
    ...
    public void show(GameActivity activity) {
        ...
        mFingerEffect.activate(marginX + 900, marginX + 900, marginY + 1000, marginY + 1300);
    }
    //========================================================
