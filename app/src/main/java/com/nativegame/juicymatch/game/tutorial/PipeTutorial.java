...
public class PipeTutorial implements Tutorial {
    ...
    // Constructors
    //--------------------------------------------------------
    public PipeTutorial(Engine engine) {
    ...
    public void show(GameActivity activity) {
        ...
        mFingerEffect.activate(marginX + 300, marginX + 300, marginY + 1000, marginY + 1300);
    }
    //========================================================
