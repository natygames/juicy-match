...
public class MatchLTutorial implements Tutorial {
    ...
    // Constructors
    //--------------------------------------------------------
    public MatchLTutorial(Engine engine) {
    ...
    public void show(GameActivity activity) {
        ...
        mFingerEffect.activate(marginX + 600, marginX + 600, marginY + 1000, marginY + 700);
    }
    //========================================================
