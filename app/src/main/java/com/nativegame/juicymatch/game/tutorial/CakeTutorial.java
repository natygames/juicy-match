...
public class CakeTutorial implements Tutorial {
    ...
    // Constructors
    //--------------------------------------------------------
    public CakeTutorial(Engine engine) {
    ...
    public void show(GameActivity activity) {
        ...
        mFingerEffect.activate(marginX + 1200, marginX + 1200, marginY + 1000, marginY + 1300);
    }
    //========================================================
