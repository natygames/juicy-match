...
public class ExplosionXSpecialTileFinder extends QuadSpecialTileFinder {

    //--------------------------------------------------------
    // Constructors
    //--------------------------------------------------------
    public ExplosionXSpecialTileFinder(Engine engine) {
        super(engine);
    }
    //========================================================
    ...
    private void checkCenter(Tile[][] tiles, int row, int col) {
        ...
        if (type == tiles[row - 1][col].getTileType()
            ...
            targetTile.setSpecialType(SpecialType.EXPLOSION_SPECIAL_TILE);
