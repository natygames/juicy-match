...
public class DoubleExplosionCombineHandler extends BaseSpecialCombineHandler {
    ...
    // Constructors
    //--------------------------------------------------------
    public DoubleExplosionCombineHandler(Engine engine) {
        super(engine);
    ...
    public boolean checkSpecialCombine(Tile[][] tiles, Tile tileA, Tile tileB, int row, int col) {
        ...
        if (tileA.getSpecialType() == SpecialType.EXPLOSION_SPECIAL_TILE
